...
type Overrides = "onDragStart" | "draggable" | "onDrop" | "onDragOver" | "onDrag" | "onDragEnd" | "onDragEnter" | "onDragLeave";
type HTMLProps = Omit<React.HTMLAttributes<HTMLDivElement>, Overrides>;

export type ChessSquareProps = SquareType & HTMLProps & {
  /**
   ...
   * @returns 
   */
  onDragStart?: (square: SquareType, ev: React.DragEvent<HTMLImageElement>) => void;
  /**
   ...
   * @returns 
   */
  onDrop?: (from: SquareType, on: SquareType, ev: React.DragEvent<HTMLDivElement>) => void;
  /**
   ...
   * @returns 
   */
  onDragOver?: (square: SquareType, ev: React.DragEvent<HTMLDivElement>) => boolean;
  /**
   ...
   * @returns 
   */
  onDrag?: (square: SquareType, ev: React.DragEvent<HTMLImageElement>) => void;
  /**
   ...
   * @returns 
   */
  onDragEnd?: (square: SquareType, ev: React.DragEvent<HTMLImageElement>) => void;
  /**
   ...
   * @returns 
   */
  onDragEnter?: (square: SquareType, ev: React.DragEvent<HTMLDivElement>) => void;
  /**
   ...
   * @returns 
   */
  onDragLeave?: (square: SquareType, ev: React.DragEvent<HTMLDivElement>) => void;
}
    ...
    >
      {
        piece && (
          <PieceImage 
            ...
            draggable={typeof draggable === "boolean" ? draggable : draggable(square)}
